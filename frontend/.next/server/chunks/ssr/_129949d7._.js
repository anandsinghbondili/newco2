...
(()=>{
    const e = new Error("Cannot find module '@/components/common/AppSidebar'");
...
(()=>{
    const e = new Error("Cannot find module '@/components/providers/ThemeProvider'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
//# sourceMappingURL=_129949d7._.js.map