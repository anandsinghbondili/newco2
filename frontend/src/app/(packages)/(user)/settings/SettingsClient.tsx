...
import { RCXTabPanel, TabsContent, TabsList, TabsTrigger } from '@/components/ext/layout/RCXTabPanel';
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <RCXTabPanel>
                    ...
                    <Card className="mb-8">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="flex justify-end">
                                <RCXPriButton onClick={() => console.log("Save changes")}>Save changes</RCXPriButton>
                            </div>
                        </CardContent>
                    </Card>
                </TabsContent>
                <TabsContent value="security">
                    <RCXSimplePanel title="Security" className='w-full h-full p-2'>
                        <div className="space-y-6">
                            <div className="grid gap-4 max-w-sm">
                                ...
                                />
                                <div className="flex justify-end">
                                    <RCXPriButton onClick={() => console.log("Update password")}>Update password</RCXPriButton>
                                </div>
                            </div>
                ...
                <TabsContent value="notifications">
                    <RCXSimplePanel title="Notifications" className='w-full h-full p-2'>
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 bg-muted/20 rounded-lg">
                ...
                <TabsContent value="appearance">
                    <RCXSimplePanel title="Appearance" className='w-full h-full p-2'>
                        <div className="space-y-6">
                            <div className="flex items-center justify-between p-4 bg-muted/20 rounded-lg">
                                <div className="space-y-1">
